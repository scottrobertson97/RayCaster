...
export function resolveAssetSource(assetRef, manifest = assetManifest) {
...
export function createImageAsset(assetRef, manifest = assetManifest) {
  const img = new Image()
...
export function createWallTextureArray(manifest = assetManifest) {
  const walls = []
